...
const defaultMenu = {
'document':{'url':'instagram.com/Raihan_m.y'},
  before: `
...
let handler = async (m, { conn, usedPrefix, __dirname }) => {
  try {
    ...
    let url = 'https://telegra.ph/file/4fd4e114bd128345a00d6.jpg'
    conn.sendButton(m.chat,
`𝚂𝚒𝚖𝚙𝚕𝚎 𝙱𝚘𝚝 𝚆𝚑𝚊𝚝𝚜𝙰𝚙𝚙 | 𝙱𝚢 Hannn

${wish()} ${name}
`, text.trim(), `https://telegra.ph/file/4fd4e114bd128345a00d6.jpg`, [
